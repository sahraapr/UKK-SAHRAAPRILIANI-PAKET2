...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Pengaduan Selesai Diproses</h1>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-12">
                                    <div class="form-group m-0">
                                        <textarea class="form-control" style="height: 150px;" readonly>{{ $data->tanggapan->tanggapan }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-3"><b>Petugas</b></div>
                                <div class="col-9">{{ $data->tanggapan->petugas->nama_petugas }}</div>
                            </div>
                        </div>
                    </div>
                </div>
