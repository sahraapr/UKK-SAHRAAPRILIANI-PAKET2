                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-12 mb-1"><b>Tanggapan</b></div>
                                <div class="col-12">
                                    <form action="{{ route('_petugas.pengaduan.proses.tanggapan', $data->id_pengaduan) }}" method="POST">
                                        @csrf
                                        
                                        <div class="form-group m-0">
                                            <textarea class="form-control" name="tanggapan" style="height: 150px;" placeholder="Beri tanggapan"></textarea>
                                        </div>
                                </div>
                            </div>
                        </div>
