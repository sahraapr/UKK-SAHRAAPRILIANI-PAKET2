                    ...
                    @if(Route::is('_petugas.alasan'))
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('_petugas.alasan.store') }}" method="POST">
                                    @csrf
...
@section('scripts')
    <script>
        var dataTable = $('#data-table').DataTable({
            ...
            responsive: true,
            autoWidth: true,
            ajax: "{{ route('_petugas.alasan.getAlasan') }}",
            columns: [
                {
                    data: 'alasan',
                    name: 'alasan'
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                ...
                var url = "{{ route('_petugas.alasan.delete', ':id') }}";
